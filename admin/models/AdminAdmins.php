...
class admin_admins_groups extends AdminTable
{
    ...
    function __construct() {
        ...
        new Field("del_restrict","Запрет на удаление",6, array('showInList'=>1, 'editInList'=>0)),
		new Field("deny_tables","Запрещенные таблицы (через запятую)",1),
		new Field("under","Основная группа",9, array('showInList'=>0, 'editInList'=>0, 'valsFromTable'=>'admins_groups', 'valsFromCategory'=>-1, 'valsEchoField'=>'name')),
        new Field("creation_time","Date of creation",4));
    }
...
<i class="glyphicon glyphicon-folder-open" style="color:#FFB800"></i> &nbsp; Настройка меню</strong><br/><div id="rubs" style="width:300px;">
...
class admin_admins extends AdminTable
{
    ...
    public $TABLE = 'admins';
    public $SORT = 'name asc';
    public $NAME = 'Пользователи админ-панели';
	public $NAME2 = 'пользователя';
    public $FIELD_UNDER = 'group_id';
   
    function __construct() {

		$this->fld[] = new Field("name","Логин",1);
